...
$packageName = 'jboss-service' # arbitrary name for the package, used in messages
...
$packageArgs = @{
  ...
  # optional
  registryUninstallerKey = 'jboss-service' #ensure this is the value in the registry
  checksum      = ''
